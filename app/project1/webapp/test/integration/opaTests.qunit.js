...
sap.ui.require(
  [
    ...
    "project1/test/integration/FoerderprogrammeListJourney",
    "project1/test/integration/FoerderprogrammeObjectPageJourney",
    "project1/test/integration/FinanzpositionenObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
